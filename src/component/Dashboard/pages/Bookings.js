        ...
        <div className="table-responsive">
          <table className="table table-hover shadow-sm rounded">
            <thead className="thead-dark">
              <tr>
                <th className="text-primary">Booking ID</th>
                <th className="text-primary">Model</th>
                <th className="text-primary">Start Destination</th>
                <th className="text-primary">End Destination</th>

...
const SelfDriveCar = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post("https://car-rental-backend-zy09.onrender.com/rental", formData, {
  ...
  <p className="plan-note">
    {selectedPlan === "8 hr" && "8hr-You get 299 km free. After 8 hours, an additional charge of ₹8 per km"}
    {selectedPlan === "24 hr" && "24hr-You get 349 km free. After 24 hours, an additional charge of ₹8 per km"}
    {selectedPlan === "Infinity" && "infinity-You get unlimited kilometers for the selected duration with no additional charges"}
  </p>
)}
        </div>
